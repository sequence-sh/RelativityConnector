...
public static class RestRetrieve
{
    ...
    {
        var urlSuffix =
            $"/Relativity.REST/api/Relativity.Objects/workspace/{workspaceId}/object/read";
        ...
        var requestQuery = new RequestClasses.RequestQuery()
        {
            ...
            {
                Object = new RequestClasses.Object() { ArtifactID = 1040848 },
                Fields = new List<RequestClasses.Field>()
                {
                    new RequestClasses.Field() { Name = "Control Number" }
                }
            }
        };
    ...
    public static class ResultClasses
    {
        ...
        public class Field
        {
            ...
            [JsonProperty("FieldCategory")] public string FieldCategory { get; set; }

            [JsonProperty("FieldType")] public string FieldType { get; set; }

            [JsonProperty("Guids")] public List<string> Guids { get; set; }

            [JsonProperty("Name")] public string Name { get; set; }

            [JsonProperty("ViewFieldID")] public int ViewFieldID { get; set; }
        }
        ...
        public class Object
        {
            ...
            [JsonProperty("Guids")] public List<object> Guids { get; set; }
        }
