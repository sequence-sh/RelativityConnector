    ...
    List<ObjectTypeIdentifier>, Array<Entity>>
{
    ...
    public override IStepFactory StepFactory =>
        new SimpleStepFactory<RelativityGetAvailableObjectTypes, Array<Entity>>();

    /// <inheritdoc />
    public override Result<Array<Entity>, IErrorBuilder> ConvertOutput(
        List<ObjectTypeIdentifier> serviceOutput)
    {
        return TryConvertToEntityArray(serviceOutput);
    }

    /// <inheritdoc />
    public override Task<List<ObjectTypeIdentifier>> SendRequest(
        IStateMonad stateMonad,
        IFieldManager service,
        int requestObject,
