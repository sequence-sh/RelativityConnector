...
{
    [SCLExample("RelativityRetrieveWorkspaceStatistics WorkspaceId: 42",expectedOutput:"(DocumentCount: 1234 FileSize: 5678)", ExecuteInTests = false)]
    public sealed class
        RelativityRetrieveWorkspaceStatistics : RelativityApiRequest<int, IWorkspaceManager, WorkspaceSummary, Entity>
    {
        ...
        /// <inheritdoc />
        public override async Task<WorkspaceSummary> SendRequest(IStateMonad stateMonad, IWorkspaceManager service,
            int requestObject,
