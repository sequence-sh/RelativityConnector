...
{
    public class RelativityRetrieveMatter : RelativityApiRequest<int, IMatterManager, MatterResponse, Entity>
    {
        /// <inheritdoc />
        public override IStepFactory StepFactory => new SimpleStepFactory<RelativityRetrieveMatter, Entity>();
        ...
        /// <inheritdoc />
        public override Task<MatterResponse> SendRequest(IStateMonad stateMonad, IMatterManager service, int requestObject,
