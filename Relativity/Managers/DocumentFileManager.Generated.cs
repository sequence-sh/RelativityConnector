...
public class TemplateDocumentFileManager1 : ManagerBase, IDocumentFileManager1
{
    ...
    /// <summary>
    /// This was not autogenerated. Do not remove it
    /// </summary>
    public Task<string> DownloadDataAsync(Int32 workspaceID, Int32 documentID)
    {
        var cancellationToken = CancellationToken.None;
        var route             = $"workspaces/{workspaceID}/documents/{documentID}/native-file";
        return DownloadAsync(route, cancellationToken);
    }
