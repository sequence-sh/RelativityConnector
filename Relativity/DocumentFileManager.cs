...
{
    public static async Task<Result<string, IError>> DownloadFile(
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result.Failure<string, IError>(
                ErrorCode.Unknown.ToErrorBuilder(e).WithLocation(errorLocation)
            );
        }
