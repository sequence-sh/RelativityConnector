...
{
    public static async Task<MappableSourceField[]> GetMappableFields(
        RelativitySettings relativitySettings,
        IFlurlClient flurlClient,
        bool catalogFieldsOnly,
        int workspaceArtifactID)
    {
        ...
        {
            CatalogFieldsOnly = catalogFieldsOnly, WorkspaceArtifactID = workspaceArtifactID
        };
    ...
    public class MappableSourceField
    {
        ...
        public override string ToString() =>
            (FriendlyName, Category, SourceName, DataType).ToString();
