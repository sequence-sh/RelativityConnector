...
{
    public partial class RelativityCreateDynamicObjectsTests : StepTestBase<RelativityCreateDynamicObjects, Array<int>>
    {
        static bool CheckCreateRequest(MassCreateRequest createRequest)
        {
            ...
            var actualValues =
                string.Join(";",
                    createRequest.ValueLists.Select(x =>
        ...
        protected override IEnumerable<ErrorCase> ErrorCases
        {
            get
            {
                ...
                yield return new ErrorCase("Not Success",
                        new RelativityCreateDynamicObjects()
                        {
                            ArtifactTypeId = Constant(10),
                            WorkspaceArtifactId = Constant(42),
